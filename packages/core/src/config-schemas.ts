...
export const UserAccessControlConfigSchema = z.object({
	 ...
	 * If specified, ONLY these users can trigger Miley sessions.
	 * Empty array means no one is allowed (effectively disables Miley).
	 ...
	 * These users cannot trigger Miley sessions.
...
/**
 * Edge configuration - the serializable configuration stored in ~/.miley/config.json
 *
