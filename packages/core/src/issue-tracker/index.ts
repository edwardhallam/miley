 ...
 * It decouples the Miley codebase from Linear-specific implementations, enabling
 ...
 * Basic usage:
 * ```typescript
 * import { IIssueTrackerService, Issue, Comment } from '@miley/core/issue-tracker';
 *
